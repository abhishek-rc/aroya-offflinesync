...
export interface ApiDestinationDestination extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    showIn: Schema.Attribute.Enumeration<['filter', 'tab', 'both']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiDiningDining extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    components: Schema.Attribute.DynamicZone<['activity.dining']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiOfferOffer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    content: Schema.Attribute.DynamicZone<['offers.content']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    main: Schema.Attribute.DynamicZone<['offers.main']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiOnboardActivityOnboardActivity
  extends Struct.CollectionTypeSchema {
  collectionName: 'onboard_activities';
  info: {
    displayName: 'Onboard Activities';
    pluralName: 'onboard-activities';
    singularName: 'onboard-activity';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    code: Schema.Attribute.String;
    components: Schema.Attribute.DynamicZone<
      ['activity.spa-and-wellness', 'activity.shorex', 'activity.dining']
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::onboard-activity.onboard-activity'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiOnboardExcursionsOnboardExcursions
  extends Struct.CollectionTypeSchema {
  collectionName: 'onboard_excursion';
  info: {
    displayName: 'Excursions';
    pluralName: 'onboard-excursion';
    singularName: 'onboard-excursions';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    components: Schema.Attribute.DynamicZone<['activity.shorex']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::onboard-excursions.onboard-excursions'
    >;
    page_name: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiPackagePackage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    has_voyage_info: Schema.Attribute.Boolean &
      ...
      Schema.Attribute.DefaultTo<false>;
    isThematic: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiSiteSettingSiteSetting extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    documents: Schema.Attribute.Relation<'manyToMany', 'api::doc.doc'>;
...
export interface ApiSpaSpa extends Struct.CollectionTypeSchema {
  collectionName: 'spas';
  info: {
    displayName: 'Spas';
    pluralName: 'spas';
  ...
  attributes: {
    ...
    components: Schema.Attribute.DynamicZone<['activity.spa-and-wellness']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::spa.spa'>;
    page_name: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::onboard-activity.onboard-activity': ApiOnboardActivityOnboardActivity;
      'api::onboard-excursions.onboard-excursions': ApiOnboardExcursionsOnboardExcursions;
